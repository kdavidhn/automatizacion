            ...
            <div id="formularioregistros">
              <form name="formulario" id="formulario" method="POST" >
                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <input type="text" class="form-control" name="no_solicitud" id="no_solicitud" maxlength="50" placeholder="No de Solicitud" oncopy="return false" onpaste="return false" required>
                </div>
                ...
                <div class="form-group col-lg-12 col-md-6 col-sm-6 col-xs-12 maxlength">
                  ...
                  <input type="text" class="form-control" name="ubicacion" id="ubicacion" maxlength="50" placeholder="Ubicacion" required>
                </div>
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12 maxlength">
                  ...
                  <input type="datetime-local" class="form-control" name="fch_inicial_actividad" id="fch_inicial_actividad" maxlength="50" required>
                </div>
                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12 maxlength">
                  <label>Fecha Final:</label>
                  <input type="datetime-local" class="form-control" name="fch_final_actividad" id="fch_final_actividad" maxlength="50"  required>
                </div>
                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 maxlength">
