...
ob_end_flush();
  ...
  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <button class="btn btn-primary pull-right" type="button"  onclick="guardaryeditar()"  ><i class="fa fa-solid fa-check"></i> Generar Reporte</button>
...
<script type="text/javascript" src="../js/reporte_act_cve.js"></script>
