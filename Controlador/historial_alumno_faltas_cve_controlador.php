...
switch ($_GET["op"]){
  ...
  break;
	...
	case 'listar_his':
 			...
 			$rspta=$falta->listar_his($cuenta1);
 		...
 		while ($reg=$rspta->fetch_object()){
 			$data[]=array(
 				"0"=>'<button title="Modificar Registro" '.$_SESSION['btnmodificar'].' class="btn btn-warning" onclick=mostrar('.$reg->id_falta.',1) ><i class="far fa-edit"></i></button>'.
