...
switch ($_GET["op"]){
	...
	if (empty($id_ambito)){
	    ...
	    if ($valor_viejo['nombre_ambito'] <> $nombre_ambito and $valor_viejo['descripcion_ambito'] <> $descripcion_ambito) {
			...
			bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'MODIFICO', ' EL NOMBRE AMBITO: ' . $valor_viejo['nombre_ambito'] . ' POR: ' . $nombre_ambito . ', Y LA DESCRIPCION DEL AMBITO: ' . $nombre_ambito . ' ');
