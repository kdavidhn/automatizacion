...
function listar1()
{
	tabla=$('#tbllistado1').dataTable(
	{
		...
		"ajax":
				{
					url: '../Controlador/actividad_cve_controlador_gestion.php?op=listar1',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function mostrar(id_actividad_voae, tipo=0)
{
	...
	$.post("../Controlador/actividad_cve_controlador_gestion.php?op=mostrar",{id_actividad_voae : id_actividad_voae}, function(data, status)
	{
...

{
	swal({
		...
		if (result) {
		 	...
		 	$.post("../Controlador/actividad_cve_controlador_gestion.php?op=aprobar", {id_actividad_voae : id_actividad_voae}, function(e){
        		swal({
