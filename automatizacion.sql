...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-08-2021 a las 20:13:51
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `inserta_actividad_externa` (IN `nombre_act` VARCHAR(255), IN `ubicacion` VARCHAR(255), IN `fecha_inicio` DATE, IN `fecha_final` DATE, IN `descripcion` VARCHAR(255), IN `ente` VARCHAR(255), IN `usuario` VARCHAR(255), IN `ambito` VARCHAR(255), IN `periodo` VARCHAR(255))  BEGIN
set @fecha_actual = (SELECT now());
if fecha_final  > @fecha_actual THEN
INSERT INTO tbl_vo_actividades (nombre_actividad,ubicacion,fch_inicial_actividad,fch_final_actividad,descripcion,staff_alumnos,id_estado,id_usuario_registro,id_ambito,periodo,tipo_actividad)
   VALUES (nombre_act,ubicacion,fecha_inicio,fecha_final,descripcion,ente,'3',usuario,ambito,periodo,2);
ELSE
INSERT INTO tbl_voae_actividades (nombre_actividad,ubicacion,fch_inicial_actividad,fch_final_actividad,descripcion,staff_alumnos,id_estado,id_usuario_registro,id_ambito,periodo,tipo_actividad)
   VALUES (nombre_act,ubicacion,fecha_inicio,fecha_final,descripcion,ente,'3',usuario,ambito,periodo,'Actividad Externa');
END IF;
END$$
...
(30747, 1, 10, '2021-08-06 11:45:57', 'Ingreso', 'A Gestion de permisos usuarios'),
(30748, 1, 10, '2021-08-06 11:46:18', 'Ingreso', 'A Gestion de permisos usuarios'),
(30749, 1, 10, '2021-08-06 11:46:22', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AINACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30750, 1, 10, '2021-08-06 11:46:22', 'Ingreso', 'A Gestion de permisos usuarios'),
(30751, 1, 115, '2021-08-06 11:46:29', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30752, 1, 110, '2021-08-06 11:46:35', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30753, 1, 110, '2021-08-06 11:46:38', 'ENVIO', 'EL No DE SOLICITUD \"13\"'),
(30754, 1, 115, '2021-08-06 11:46:43', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30755, 1, 10, '2021-08-06 11:47:02', 'Ingreso', 'A Gestion de permisos usuarios'),
(30756, 1, 10, '2021-08-06 11:47:13', 'Ingreso', 'A Gestion de permisos usuarios'),
(30757, 1, 10, '2021-08-06 11:47:16', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30758, 1, 10, '2021-08-06 11:47:16', 'Ingreso', 'A Gestion de permisos usuarios'),
(30759, 1, 118, '2021-08-06 11:47:33', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30760, 1, 115, '2021-08-06 11:48:02', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30761, 1, 121, '2021-08-06 11:48:07', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30762, 1, 110, '2021-08-06 11:48:09', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30763, 1, 10, '2021-08-06 11:48:35', 'Ingreso', 'A Gestion de permisos usuarios'),
(30764, 1, 10, '2021-08-06 11:48:41', 'Ingreso', 'A Gestion de permisos usuarios'),
(30765, 1, 10, '2021-08-06 11:48:44', 'MODIFICO', 'EL INSERTAR AINACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30766, 1, 10, '2021-08-06 11:48:44', 'Ingreso', 'A Gestion de permisos usuarios'),
(30767, 1, 110, '2021-08-06 11:48:49', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30768, 1, 110, '2021-08-06 11:49:18', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30769, 1, 110, '2021-08-06 11:49:45', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30770, 1, 110, '2021-08-06 11:50:36', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30771, 1, 110, '2021-08-06 11:50:49', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30772, 1, 110, '2021-08-06 11:50:56', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30773, 1, 10, '2021-08-06 11:51:01', 'Ingreso', 'A Gestion de permisos usuarios'),
(30774, 1, 110, '2021-08-06 11:51:40', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30775, 1, 110, '2021-08-06 11:52:17', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30776, 1, 110, '2021-08-06 11:53:05', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30777, 1, 110, '2021-08-06 11:53:26', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30778, 1, 110, '2021-08-06 11:53:37', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30779, 1, 10, '2021-08-06 11:53:42', 'Ingreso', 'A Gestion de permisos usuarios'),
(30780, 1, 10, '2021-08-06 11:53:46', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30781, 1, 10, '2021-08-06 11:53:46', 'Ingreso', 'A Gestion de permisos usuarios'),
(30782, 1, 110, '2021-08-06 11:53:48', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30783, 1, 118, '2021-08-06 11:54:12', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30784, 1, 114, '2021-08-06 11:54:19', 'INGRESO', 'A Horas VOAE Gestión'),
(30785, 1, 114, '2021-08-06 11:55:47', 'INGRESO', 'A Horas VOAE Gestión'),
(30786, 1, 114, '2021-08-06 11:56:26', 'INGRESO', 'A Horas VOAE Gestión'),
(30787, 1, 113, '2021-08-06 11:57:04', 'INGRESO', 'A registro de faltas'),
(30788, 1, 113, '2021-08-06 11:57:40', 'INGRESO', 'A registro de faltas'),
(30789, 1, 113, '2021-08-06 11:58:08', 'INGRESO', 'A registro de faltas'),
(30790, 1, 113, '2021-08-06 11:58:30', 'INGRESO', 'A registro de faltas'),
(30791, 1, 10, '2021-08-06 11:58:47', 'Ingreso', 'A Gestion de permisos usuarios'),
(30792, 1, 10, '2021-08-06 11:58:51', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30793, 1, 10, '2021-08-06 11:58:51', 'Ingreso', 'A Gestion de permisos usuarios'),
(30794, 1, 113, '2021-08-06 11:58:53', 'INGRESO', 'A registro de faltas'),
(30795, 1, 115, '2021-08-06 11:59:15', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30796, 1, 114, '2021-08-06 12:00:47', 'INGRESO', 'A Horas VOAE Gestión'),
(30797, 1, 110, '2021-08-06 12:05:36', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30798, 1, 110, '2021-08-06 12:06:13', 'INSERTO', 'LA ACTIVIDAD: \"FSDFSDFSDF\"'),
(30799, 1, 110, '2021-08-06 12:07:06', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30800, 1, 110, '2021-08-06 12:07:11', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30801, 1, 110, '2021-08-06 12:08:13', 'INSERTO', 'LA ACTIVIDAD: \"BAILE\"'),
(30802, 1, 114, '2021-08-06 12:08:29', 'INGRESO', 'A Horas VOAE Gestión'),
(30803, 1, 110, '2021-08-06 12:08:45', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30804, 1, 110, '2021-08-06 12:08:48', 'ENVIO', 'EL No DE SOLICITUD \"1\"'),
(30805, 1, 115, '2021-08-06 12:08:59', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30806, 1, 115, '2021-08-06 12:09:03', 'APROBO', 'EL No DE SOLICITUD\"1\"'),
(30807, 1, 121, '2021-08-06 12:09:10', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30808, 1, 121, '2021-08-06 12:09:22', 'FINALIZO', 'EL NO DE SOLICITUD \"1\"'),
(30809, 1, 118, '2021-08-06 12:11:16', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30810, 1, 118, '2021-08-06 12:11:48', 'INSERTO', 'EL INFORME CON ID: \"\"'),
(30811, 1, 118, '2021-08-06 12:12:00', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30812, 1, 118, '2021-08-06 12:12:12', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30813, 1, 118, '2021-08-06 12:24:15', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30814, 1, 110, '2021-08-06 12:24:35', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30815, 1, 110, '2021-08-06 12:25:01', 'INSERTO', 'LA ACTIVIDAD: \"Prueba\"'),
(30816, 1, 110, '2021-08-06 12:25:05', 'ENVIO', 'EL No DE SOLICITUD \"2\"'),
(30817, 1, 115, '2021-08-06 12:25:08', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30818, 1, 115, '2021-08-06 12:25:11', 'APROBO', 'EL No DE SOLICITUD\"2\"'),
(30819, 1, 121, '2021-08-06 12:25:13', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30820, 1, 121, '2021-08-06 12:28:44', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30821, 1, 118, '2021-08-06 12:28:52', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30822, 1, 115, '2021-08-06 12:30:19', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30823, 1, 121, '2021-08-06 12:30:23', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30824, 1, 121, '2021-08-06 12:30:30', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30825, 1, 118, '2021-08-06 12:30:35', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30826, 1, 121, '2021-08-06 12:30:37', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30827, 1, 118, '2021-08-06 12:30:41', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30828, 1, 118, '2021-08-06 12:34:21', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30829, 1, 110, '2021-08-06 12:36:01', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30830, 1, 110, '2021-08-06 12:36:30', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30831, 1, 110, '2021-08-06 12:38:15', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30832, 1, 110, '2021-08-06 12:39:47', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30833, 1, 121, '2021-08-06 13:47:06', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30834, 1, 121, '2021-08-06 13:47:44', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30835, 1, 121, '2021-08-06 13:48:06', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30836, 1, 121, '2021-08-06 13:48:43', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30837, 1, 121, '2021-08-06 13:49:07', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30838, 1, 121, '2021-08-06 13:49:23', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30839, 1, 121, '2021-08-06 13:49:31', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30840, 1, 121, '2021-08-06 13:51:06', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30841, 1, 121, '2021-08-06 13:51:50', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30842, 1, 121, '2021-08-06 13:52:16', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30843, 1, 121, '2021-08-06 13:52:34', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30844, 1, 121, '2021-08-06 13:52:43', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30845, 1, 121, '2021-08-06 13:53:53', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30846, 1, 121, '2021-08-06 13:53:59', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30847, 1, 121, '2021-08-06 13:54:11', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30848, 1, 121, '2021-08-06 13:54:33', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30849, 1, 121, '2021-08-06 13:54:45', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30850, 1, 121, '2021-08-06 13:54:56', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30851, 1, 121, '2021-08-06 13:54:58', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30852, 1, 121, '2021-08-06 13:55:17', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30853, 1, 121, '2021-08-06 13:55:19', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(30854, 1, 110, '2021-08-06 13:55:59', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30855, 1, 121, '2021-08-06 13:57:36', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30856, 1, 121, '2021-08-06 13:58:25', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30857, 1, 121, '2021-08-06 13:58:39', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30858, 1, 121, '2021-08-06 13:58:58', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30859, 1, 121, '2021-08-06 13:59:20', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30860, 1, 121, '2021-08-06 13:59:35', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30861, 1, 121, '2021-08-06 14:00:37', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30862, 1, 121, '2021-08-06 14:00:47', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30863, 1, 121, '2021-08-06 14:01:08', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30864, 1, 121, '2021-08-06 14:01:29', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30865, 1, 118, '2021-08-06 14:01:35', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30866, 1, 121, '2021-08-06 14:01:37', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30867, 1, 121, '2021-08-06 14:02:50', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30868, 1, 121, '2021-08-06 14:03:01', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30869, 1, 121, '2021-08-06 14:03:31', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30870, 1, 121, '2021-08-06 14:03:43', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30871, 1, 121, '2021-08-06 14:04:01', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30872, 1, 121, '2021-08-06 14:04:58', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30873, 1, 115, '2021-08-06 14:05:57', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30874, 1, 115, '2021-08-06 14:06:34', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30875, 1, 110, '2021-08-06 14:06:53', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30876, 1, 110, '2021-08-06 14:07:47', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30877, 1, 110, '2021-08-06 14:07:53', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30878, 1, 110, '2021-08-06 14:08:02', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30879, 1, 113, '2021-08-06 14:08:45', 'INGRESO', 'A registro de faltas'),
(30880, 1, 114, '2021-08-06 14:08:56', 'INGRESO', 'A Horas VOAE Gestión'),
(30881, 1, 121, '2021-08-06 14:09:25', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30882, 1, 118, '2021-08-06 14:09:31', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30883, 1, 118, '2021-08-06 14:09:35', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30884, 1, 118, '2021-08-06 14:09:51', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30885, 1, 118, '2021-08-06 14:11:21', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30886, 1, 118, '2021-08-06 14:11:47', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30887, 1, 118, '2021-08-06 14:12:02', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30888, 1, 118, '2021-08-06 14:12:06', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30889, 1, 114, '2021-08-06 14:12:27', 'INGRESO', 'A Horas VOAE Gestión'),
(30890, 1, 113, '2021-08-06 14:12:32', 'INGRESO', 'A registro de faltas'),
(30891, 1, 118, '2021-08-06 14:15:53', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30892, 1, 119, '2021-08-06 14:18:49', 'INGRESO', 'A Memorandums'),
(30893, 1, 120, '2021-08-06 14:19:03', 'INGRESO', 'A Mantenimiento de tipo Meorandum'),
(30894, 1, 120, '2021-08-06 14:19:19', 'INSERTO', 'EL TIPO DE memorandum \"MEMORANDUM ACTIVIDADES\"'),
(30895, 1, 119, '2021-08-06 14:19:23', 'INGRESO', 'A Memorandums'),
(30896, 1, 119, '2021-08-06 14:19:42', 'INSERTO', 'EL MEMORANDUM \"NM-0001\"'),
(30897, 1, 119, '2021-08-06 14:19:52', 'INGRESO', 'A Memorandums'),
(30898, 1, 113, '2021-08-06 14:20:41', 'INGRESO', 'A registro de faltas'),
(30899, 1, 113, '2021-08-06 14:21:11', 'INGRESO', 'A registro de faltas'),
(30900, 1, 113, '2021-08-06 14:21:43', 'INGRESO', 'A registro de faltas'),
(30901, 1, 113, '2021-08-06 14:22:43', 'INGRESO', 'A registro de faltas'),
(30902, 1, 113, '2021-08-06 14:27:04', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Daniel Enrique  Ramirez Rivera'),
(30903, 1, 113, '2021-08-06 14:27:47', 'INGRESO', 'A registro de faltas'),
(30904, 1, 114, '2021-08-06 14:29:08', 'INGRESO', 'A Horas VOAE Gestión'),
(30905, 1, 114, '2021-08-06 14:29:37', 'INSERTO', 'LA ACTIVIDAD: CIENCIA'),
(30906, 1, 114, '2021-08-06 14:29:37', 'INGRESO', 'A Horas VOAE Gestión'),
(30907, 1, 113, '2021-08-06 14:30:36', 'INGRESO', 'A registro de faltas'),
(30908, 1, 113, '2021-08-06 14:30:48', 'INGRESO', 'A registro de faltas'),
(30909, 1, 113, '2021-08-06 14:31:09', 'INGRESO', 'A registro de faltas'),
(30910, 1, 113, '2021-08-06 14:31:25', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Enrique  Rivera'),
(30911, 1, 113, '2021-08-06 14:31:35', 'INGRESO', 'A registro de faltas'),
(30912, 1, 113, '2021-08-06 14:33:00', 'INGRESO', 'A registro de faltas'),
(30913, 1, 113, '2021-08-06 14:33:19', 'INGRESO', 'A registro de faltas'),
(30914, 1, 113, '2021-08-06 14:33:39', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Daniel Enrique  Ramirez Rivera'),
(30915, 1, 113, '2021-08-06 14:33:41', 'INGRESO', 'A registro de faltas'),
(30916, 1, 113, '2021-08-06 14:33:58', 'INGRESO', 'A registro de faltas'),
(30917, 1, 113, '2021-08-06 14:35:36', 'INGRESO', 'A registro de faltas'),
(30918, 1, 113, '2021-08-06 14:35:57', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Fredy andersson MOTINO FLORES'),
(30919, 1, 113, '2021-08-06 14:36:12', 'INGRESO', 'A registro de faltas'),
(30920, 1, 113, '2021-08-06 14:36:24', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Fredy andersson MOTINO FLORES'),
(30921, 1, 113, '2021-08-06 14:36:24', 'INGRESO', 'A registro de faltas'),
(30922, 1, 113, '2021-08-06 14:36:49', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Lisa Lucas'),
(30923, 1, 113, '2021-08-06 14:36:49', 'INGRESO', 'A registro de faltas'),
(30924, 1, 113, '2021-08-06 14:37:00', 'MODIFICO', ' LA FALTA CON EL ID 81: EDITO DESCRIPCIÓN'),
(30925, 1, 113, '2021-08-06 14:37:00', 'INGRESO', 'A registro de faltas'),
(30926, 1, 113, '2021-08-06 14:38:21', 'INGRESO', 'A registro de faltas'),
(30927, 1, 113, '2021-08-06 14:38:23', 'ELIMINO', ' LA FALTA CON EL ID 77: DEL ALUMNO: Enrique  Rivera'),
(30928, 1, 113, '2021-08-06 14:38:26', 'ELIMINO', ' LA FALTA CON EL ID 81: DEL ALUMNO: Lisa Lucas'),
(30929, 1, 113, '2021-08-06 14:38:34', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Lisa Lucas'),
(30930, 1, 113, '2021-08-06 14:38:34', 'INGRESO', 'A registro de faltas'),
(30931, 1, 113, '2021-08-06 14:38:45', 'INGRESO', 'A registro de faltas'),
(30932, 1, 113, '2021-08-06 14:38:53', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Fredy andersson MOTINO FLORES'),
(30933, 1, 113, '2021-08-06 14:38:53', 'INGRESO', 'A registro de faltas'),
(30934, 1, 113, '2021-08-06 14:39:01', 'INGRESO', 'A registro de faltas'),
(30935, 1, 113, '2021-08-06 14:39:04', 'ELIMINO', ' LA FALTA CON EL ID 78: DEL ALUMNO: Daniel Enrique  Ramirez Rivera'),
(30936, 1, 113, '2021-08-06 14:39:12', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Lisa Lucas'),
(30937, 1, 113, '2021-08-06 14:39:12', 'INGRESO', 'A registro de faltas'),
(30938, 1, 118, '2021-08-06 15:21:51', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30939, 1, 110, '2021-08-06 15:21:58', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30940, 1, 110, '2021-08-06 15:22:35', 'INSERTO', 'LA ACTIVIDAD: \"Cultura\"'),
(30941, 1, 110, '2021-08-06 15:22:41', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30942, 1, 8, '2021-08-06 15:22:45', 'Ingreso', 'A Bitacora del sistema'),
(30943, 1, 110, '2021-08-06 15:23:04', 'ENVIO', 'EL No DE SOLICITUD \"12\"'),
(30944, 1, 8, '2021-08-06 15:23:06', 'Ingreso', 'A Bitacora del sistema'),
(30945, 1, 115, '2021-08-06 15:23:15', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30946, 1, 115, '2021-08-06 15:23:19', 'APROBO', 'EL No DE SOLICITUD\"12\"'),
(30947, 1, 8, '2021-08-06 15:23:21', 'Ingreso', 'A Bitacora del sistema'),
(30948, 1, 121, '2021-08-06 15:23:27', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30949, 1, 121, '2021-08-06 15:23:35', 'FINALIZO', 'EL NO DE SOLICITUD \"\"'),
(30950, 1, 8, '2021-08-06 15:23:37', 'Ingreso', 'A Bitacora del sistema'),
(30951, 1, 121, '2021-08-06 15:23:48', 'FINALIZO', 'EL NO DE SOLICITUD \"12\"'),
(30952, 1, 121, '2021-08-06 15:23:51', 'FINALIZO', 'EL NO DE SOLICITUD \"12\"'),
(30953, 1, 121, '2021-08-06 15:24:57', 'INGRESO', 'A Solicitud de Actividades CVE'),
(30954, 1, 121, '2021-08-06 15:25:01', 'FINALIZO', 'EL NO DE SOLICITUD \"12\"'),
(30955, 1, 8, '2021-08-06 15:25:04', 'Ingreso', 'A Bitacora del sistema'),
(30956, 1, 118, '2021-08-06 15:25:20', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30957, 1, 119, '2021-08-06 15:26:50', 'INGRESO', 'A Memorandums'),
(30958, 1, 119, '2021-08-06 15:28:50', 'INGRESO', 'A Memorandums'),
(30959, 1, 10, '2021-08-06 15:28:57', 'Ingreso', 'A Gestion de permisos usuarios'),
(30960, 1, 10, '2021-08-06 15:29:07', 'Ingreso', 'A Gestion de permisos usuarios'),
(30961, 1, 10, '2021-08-06 15:29:12', 'MODIFICO', 'EL INSERTAR AINACTIVO,EL MODIFICAR AINACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30962, 1, 10, '2021-08-06 15:29:12', 'Ingreso', 'A Gestion de permisos usuarios'),
(30963, 1, 119, '2021-08-06 15:29:15', 'INGRESO', 'A Memorandums'),
(30964, 1, 10, '2021-08-06 15:29:28', 'Ingreso', 'A Gestion de permisos usuarios'),
(30965, 1, 10, '2021-08-06 15:29:35', 'MODIFICO', 'EL INSERTAR AINACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AINACTIVO ,EL VISUALIZAR AACTIVO '),
(30966, 1, 10, '2021-08-06 15:29:35', 'Ingreso', 'A Gestion de permisos usuarios'),
(30967, 1, 119, '2021-08-06 15:29:37', 'INGRESO', 'A Memorandums'),
(30968, 1, 119, '2021-08-06 15:29:59', 'INGRESO', 'A Memorandums'),
(30969, 1, 10, '2021-08-06 15:30:06', 'Ingreso', 'A Gestion de permisos usuarios'),
(30970, 1, 10, '2021-08-06 15:30:09', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30971, 1, 10, '2021-08-06 15:30:09', 'Ingreso', 'A Gestion de permisos usuarios'),
(30972, 1, 119, '2021-08-06 15:30:12', 'INGRESO', 'A Memorandums'),
(30973, 1, 113, '2021-08-06 15:30:19', 'INGRESO', 'A registro de faltas'),
(30974, 1, 10, '2021-08-06 15:30:30', 'Ingreso', 'A Gestion de permisos usuarios'),
(30975, 1, 10, '2021-08-06 15:30:34', 'MODIFICO', 'EL INSERTAR AINACTIVO,EL MODIFICAR AINACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30976, 1, 10, '2021-08-06 15:30:34', 'Ingreso', 'A Gestion de permisos usuarios'),
(30977, 1, 113, '2021-08-06 15:30:36', 'INGRESO', 'A registro de faltas'),
(30978, 1, 10, '2021-08-06 15:30:57', 'Ingreso', 'A Gestion de permisos usuarios'),
(30979, 1, 10, '2021-08-06 15:31:01', 'MODIFICO', 'EL INSERTAR AINACTIVO,EL MODIFICAR AINACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30980, 1, 10, '2021-08-06 15:31:01', 'Ingreso', 'A Gestion de permisos usuarios'),
(30981, 1, 113, '2021-08-06 15:31:03', 'INGRESO', 'A registro de faltas'),
(30982, 1, 10, '2021-08-06 15:31:25', 'Ingreso', 'A Gestion de permisos usuarios'),
(30983, 1, 10, '2021-08-06 15:31:28', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30984, 1, 10, '2021-08-06 15:31:28', 'Ingreso', 'A Gestion de permisos usuarios'),
(30985, 1, 10, '2021-08-06 15:31:35', 'Ingreso', 'A Gestion de permisos usuarios'),
(30986, 1, 10, '2021-08-06 15:31:38', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AINACTIVO ,EL VISUALIZAR AACTIVO '),
(30987, 1, 10, '2021-08-06 15:31:38', 'Ingreso', 'A Gestion de permisos usuarios'),
(30988, 1, 113, '2021-08-06 15:31:40', 'INGRESO', 'A registro de faltas'),
(30989, 1, 10, '2021-08-06 15:31:49', 'Ingreso', 'A Gestion de permisos usuarios'),
(30990, 1, 10, '2021-08-06 15:31:58', 'Ingreso', 'A Gestion de permisos usuarios'),
(30991, 1, 10, '2021-08-06 15:32:01', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(30992, 1, 10, '2021-08-06 15:32:01', 'Ingreso', 'A Gestion de permisos usuarios'),
(30993, 1, 113, '2021-08-06 15:32:03', 'INGRESO', 'A registro de faltas'),
(30994, 1, 118, '2021-08-06 15:41:29', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30995, 1, 118, '2021-08-06 15:42:05', 'INSERTO', 'EL INFORME CON ID: \"\"'),
(30996, 1, 8, '2021-08-06 15:42:11', 'Ingreso', 'A Bitacora del sistema'),
(30997, 1, 118, '2021-08-06 15:42:37', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(30998, 1, 118, '2021-08-06 15:44:03', 'MODIFICO', 'EL INFORME CON ID: \"4\"'),
(30999, 1, 8, '2021-08-06 15:44:12', 'Ingreso', 'A Bitacora del sistema'),
(31000, 1, 118, '2021-08-06 15:45:09', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31001, 1, 118, '2021-08-06 15:45:12', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31002, 1, 8, '2021-08-06 15:45:20', 'Ingreso', 'A Bitacora del sistema'),
(31003, 1, 106, '2021-08-06 16:47:08', 'INGRESO', 'A Mantenimiento de estados'),
(31004, 1, 105, '2021-08-06 16:47:13', 'INGRESO', 'A Mantenimiento de ambitos'),
(31005, 1, 105, '2021-08-06 16:47:28', 'MODIFICO', 'EL NOMBRE DEL AMBITO: PRUEBA POR: DEPORTIVO '),
(31006, 1, 105, '2021-08-06 16:47:50', 'MODIFICO', 'EL NOMBRE DEL AMBITO: PRUEBA2 POR: Cultural-ArtísticO '),
(31007, 1, 105, '2021-08-06 16:48:09', 'MODIFICO', 'EL NOMBRE DEL AMBITO: SOCIAL CULTURALPRE POR: SOCIAL '),
(31008, 1, 110, '2021-08-06 16:49:01', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31009, 1, 115, '2021-08-06 16:49:05', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31010, 1, 121, '2021-08-06 16:49:09', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31011, 1, 118, '2021-08-06 16:49:13', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31012, 1, 118, '2021-08-06 16:50:37', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31013, 1, 118, '2021-08-06 16:51:53', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31014, 1, 121, '2021-08-06 16:52:08', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31015, 1, 118, '2021-08-06 16:52:13', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31016, 1, 118, '2021-08-06 16:52:25', 'INSERTO', 'EL INFORME PARA LA ACTIVIDAD CON ID: \"64\"'),
(31017, 1, 118, '2021-08-06 16:52:31', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31018, 1, 118, '2021-08-06 16:52:43', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31019, 1, 118, '2021-08-06 16:53:56', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31020, 1, 118, '2021-08-06 16:54:04', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31021, 1, 118, '2021-08-06 16:54:31', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31022, 1, 119, '2021-08-06 16:54:44', 'INGRESO', 'A Memorandums'),
(31023, 1, 119, '2021-08-06 16:54:54', 'INGRESO', 'A Memorandums'),
(31024, 1, 10, '2021-08-06 16:55:39', 'Ingreso', 'A Gestion de permisos usuarios'),
(31025, 1, 10, '2021-08-06 16:55:54', 'Ingreso', 'A Gestion de permisos usuarios'),
(31026, 1, 10, '2021-08-06 16:55:58', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(31027, 1, 10, '2021-08-06 16:55:58', 'Ingreso', 'A Gestion de permisos usuarios'),
(31028, 1, 10, '2021-08-06 16:56:14', 'Ingreso', 'A Gestion de permisos usuarios'),
(31029, 1, 10, '2021-08-06 16:56:17', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AINACTIVO '),
(31030, 1, 10, '2021-08-06 16:56:17', 'Ingreso', 'A Gestion de permisos usuarios'),
(31031, 1, 10, '2021-08-06 16:56:34', 'Ingreso', 'A Gestion de permisos usuarios'),
(31032, 1, 10, '2021-08-06 16:56:36', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(31033, 1, 10, '2021-08-06 16:56:36', 'Ingreso', 'A Gestion de permisos usuarios'),
(31034, 1, 114, '2021-08-06 16:56:46', 'INGRESO', 'A Horas VOAE Gestión'),
(31035, 1, 10, '2021-08-06 16:57:00', 'Ingreso', 'A Gestion de permisos usuarios'),
(31036, 1, 10, '2021-08-06 16:57:03', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(31037, 1, 10, '2021-08-06 16:57:03', 'Ingreso', 'A Gestion de permisos usuarios'),
(31038, 1, 10, '2021-08-06 16:57:14', 'Ingreso', 'A Gestion de permisos usuarios'),
(31039, 1, 10, '2021-08-06 16:57:17', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AINACTIVO '),
(31040, 1, 10, '2021-08-06 16:57:17', 'Ingreso', 'A Gestion de permisos usuarios'),
(31041, 1, 10, '2021-08-06 16:57:27', 'Ingreso', 'A Gestion de permisos usuarios'),
(31042, 1, 10, '2021-08-06 16:57:31', 'Ingreso', 'A Gestion de permisos usuarios'),
(31043, 1, 10, '2021-08-06 16:57:34', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(31044, 1, 10, '2021-08-06 16:57:34', 'Ingreso', 'A Gestion de permisos usuarios'),
(31045, 1, 10, '2021-08-06 16:57:42', 'Ingreso', 'A Gestion de permisos usuarios'),
(31046, 1, 10, '2021-08-06 16:57:45', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AINACTIVO '),
(31047, 1, 10, '2021-08-06 16:57:45', 'Ingreso', 'A Gestion de permisos usuarios'),
(31048, 1, 10, '2021-08-06 16:57:54', 'Ingreso', 'A Gestion de permisos usuarios'),
(31049, 1, 10, '2021-08-06 16:58:03', 'Ingreso', 'A Gestion de permisos usuarios'),
(31050, 1, 10, '2021-08-06 16:58:06', 'MODIFICO', 'EL INSERTAR AACTIVO,EL MODIFICAR AACTIVO ,EL ELIMINAR AACTIVO ,EL VISUALIZAR AACTIVO '),
(31051, 1, 10, '2021-08-06 16:58:06', 'Ingreso', 'A Gestion de permisos usuarios'),
(31052, 1, 114, '2021-08-06 16:58:08', 'INGRESO', 'A Horas VOAE Gestión'),
(31053, 1, 119, '2021-08-06 16:58:12', 'INGRESO', 'A Memorandums'),
(31054, 1, 118, '2021-08-06 16:59:41', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31055, 1, 118, '2021-08-06 18:52:05', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31056, 1, 115, '2021-08-06 18:52:19', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31057, 1, 118, '2021-08-06 18:52:23', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31058, 1, 118, '2021-08-06 18:52:45', 'INSERTO', 'EL INFORME CON ID: \"\"'),
(31059, 1, 118, '2021-08-06 18:52:48', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31060, 1, 118, '2021-08-06 18:52:51', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 64'),
(31061, 1, 118, '2021-08-06 18:53:06', 'IMPORTO', 'LISTADO DE ASISTENCIA DE LA ACTIVIDAD CON ID \"64\", CON: 32 REGISTROS NUEVOS Y 0 ACTUALIZACIONES'),
(31062, 1, 118, '2021-08-06 18:53:15', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 64'),
(31063, 1, 118, '2021-08-06 18:53:34', 'ELIMINO', 'LA ASISTENCIA CON ID \"306\" EN LA ACTIVIDAD CON ID \"64\" '),
(31064, 1, 8, '2021-08-06 18:53:37', 'Ingreso', 'A Bitacora del sistema'),
(31065, 1, 118, '2021-08-06 18:53:51', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31066, 1, 118, '2021-08-06 18:55:36', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 64'),
(31067, 1, 118, '2021-08-06 18:55:56', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 64'),
(31068, 1, 118, '2021-08-06 18:57:01', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 64'),
(31069, 1, 118, '2021-08-06 18:57:28', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31070, 1, 118, '2021-08-06 18:57:31', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 64'),
(31071, 1, 118, '2021-08-06 18:57:43', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31072, 1, 114, '2021-08-06 18:57:45', 'INGRESO', 'A Horas VOAE Gestión'),
(31073, 1, 113, '2021-08-06 18:57:58', 'INGRESO', 'A registro de faltas'),
(31074, 1, 114, '2021-08-06 18:58:05', 'INGRESO', 'A Horas VOAE Gestión'),
(31075, 1, 110, '2021-08-06 18:59:21', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31076, 1, 110, '2021-08-06 18:59:58', 'INSERTO', 'LA ACTIVIDAD: \"Cultura\"'),
(31077, 1, 110, '2021-08-06 19:00:11', 'ENVIO', 'EL No DE SOLICITUD \"22\"'),
(31078, 1, 115, '2021-08-06 19:00:16', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31079, 1, 115, '2021-08-06 19:00:19', 'APROBO', 'EL No DE SOLICITUD\"22\"'),
(31080, 1, 121, '2021-08-06 19:00:23', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31081, 1, 121, '2021-08-06 19:00:28', 'FINALIZO', 'EL NO DE SOLICITUD \"22\"'),
(31082, 1, 121, '2021-08-06 19:01:13', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31083, 1, 118, '2021-08-06 19:01:15', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31084, 1, 121, '2021-08-06 19:01:18', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31085, 1, 121, '2021-08-06 19:01:21', 'FINALIZO', 'EL NO DE SOLICITUD \"22\"'),
(31086, 1, 110, '2021-08-06 19:13:37', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31087, 1, 110, '2021-08-06 19:21:13', 'INSERTO', 'LA ACTIVIDAD: \"INFORMATICA ADMINISTRATIVA\"'),
(31088, 1, 110, '2021-08-06 19:23:36', 'ENVIO', 'EL No DE SOLICITUD \"2\"'),
(31089, 1, 115, '2021-08-06 19:23:45', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31090, 1, 115, '2021-08-06 19:26:38', 'DENEGO', 'EL No DE SOLICITUD\"2\"'),
(31091, 1, 115, '2021-08-06 19:27:20', 'APROBO', 'EL No DE SOLICITUD\"2\"'),
(31092, 1, 121, '2021-08-06 19:27:30', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31093, 1, 121, '2021-08-06 19:27:51', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(31094, 1, 121, '2021-08-06 19:29:15', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31095, 1, 121, '2021-08-06 19:29:20', 'FINALIZO', 'EL NO DE SOLICITUD \"2\"'),
(31096, 1, 118, '2021-08-06 19:31:36', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31097, 1, 118, '2021-08-06 19:33:41', 'INSERTO', 'EL INFORME CON ID: \"\"'),
(31098, 1, 118, '2021-08-06 19:33:56', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 66'),
(31099, 1, 118, '2021-08-06 19:34:53', 'INSERTO', 'LA ASISTENCIA DEL ESTUDIANTE CON CUENTA \"2\" EN LA ACTIVIDAD CON ID \"66\"'),
(31100, 1, 118, '2021-08-06 19:35:12', 'IMPORTO', 'LISTADO DE ASISTENCIA DE LA ACTIVIDAD CON ID \"66\", CON: 134 REGISTROS NUEVOS Y 0 ACTUALIZACIONES'),
(31101, 1, 118, '2021-08-06 19:37:09', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31102, 1, 118, '2021-08-06 19:39:33', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 66'),
(31103, 1, 114, '2021-08-06 19:41:55', 'INGRESO', 'A Horas VOAE Gestión'),
(31104, 1, 114, '2021-08-06 19:43:31', 'INSERTO', 'LA ACTIVIDAD: Torneo Futbolito'),
(31105, 1, 114, '2021-08-06 19:43:31', 'INGRESO', 'A Horas VOAE Gestión'),
(31106, 1, 114, '2021-08-06 19:46:19', 'INSERTO', 'HORAS VOAE AL ALUMNO: Linda Ceciclia Villatoro Hernandez, LA CANTIDAD DE: 30 HORAS, DE LA ACTIVIDAD: Torneo Futbolito'),
(31107, 1, 116, '2021-08-06 19:49:12', 'INGRESO', 'A Historial de Horas Alumno'),
(31108, 1, 114, '2021-08-06 19:49:31', 'INGRESO', 'A Horas VOAE Gestión'),
(31109, 1, 113, '2021-08-06 19:57:35', 'INGRESO', 'A registro de faltas'),
(31110, 1, 113, '2021-08-06 19:58:16', 'INSERTO', 'UNA NUEVA FALTA PARA EL ALUMNO ALUMNO: Linda Ceciclia Villatoro Hernandez'),
(31111, 1, 113, '2021-08-06 19:58:17', 'INGRESO', 'A registro de faltas'),
(31112, 1, 113, '2021-08-06 20:03:56', 'INGRESO', 'A registro de faltas'),
(31113, 1, 119, '2021-08-06 20:04:23', 'INGRESO', 'A Memorandums'),
(31114, 1, 119, '2021-08-06 20:05:58', 'INSERTO', 'EL MEMORANDUM \"NM-0002\"'),
(31115, 1, 119, '2021-08-06 20:07:06', 'INGRESO', 'A Memorandums'),
(31116, 1, 118, '2021-08-06 21:47:45', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31117, 1, 118, '2021-08-06 21:48:02', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31118, 1, 118, '2021-08-06 21:48:15', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31119, 1, 118, '2021-08-06 21:48:50', 'INGRESO', 'A LA LISTA DE ASISTENCIA DE LA ACTIVIDAD ID: 66'),
(31120, 1, 114, '2021-08-06 21:50:42', 'INGRESO', 'A Horas VOAE Gestión'),
(31121, 1, 114, '2021-08-06 21:52:56', 'INGRESO', 'A Horas VOAE Gestión'),
(31122, 1, 114, '2021-08-06 21:53:16', 'INGRESO', 'A Horas VOAE Gestión'),
(31123, 1, 114, '2021-08-06 21:53:23', 'INGRESO', 'A Horas VOAE Gestión'),
(31124, 1, 114, '2021-08-06 21:53:29', 'INGRESO', 'A Horas VOAE Gestión'),
(31125, 1, 114, '2021-08-06 21:54:01', 'INGRESO', 'A Horas VOAE Gestión'),
(31126, 1, 116, '2021-08-06 21:54:06', 'INGRESO', 'A Historial de Horas Alumno'),
(31127, 1, 114, '2021-08-06 21:54:10', 'INGRESO', 'A Horas VOAE Gestión'),
(31128, 1, 114, '2021-08-06 21:56:20', 'INGRESO', 'A Horas VOAE Gestión'),
(31129, 1, 114, '2021-08-06 22:01:07', 'INGRESO', 'A Actividades Externas'),
(31130, 1, 118, '2021-08-06 22:01:16', 'INGRESO', 'A GESTION DE DOCUMENTACION'),
(31131, 1, 114, '2021-08-06 22:01:19', 'INGRESO', 'A Actividades Externas'),
(31132, 1, 114, '2021-08-06 22:01:38', 'INGRESO', 'A Actividades Externas'),
(31133, 1, 114, '2021-08-06 22:02:50', 'INGRESO', 'A Horas VOAE Gestión'),
(31134, 1, 114, '2021-08-06 22:02:52', 'INGRESO', 'A Actividades Externas'),
(31135, 1, 121, '2021-08-06 22:03:17', 'INGRESO', 'A Solicitud de Actividades CVE'),
(31136, 1, 114, '2021-08-06 22:05:07', 'INGRESO', 'A Horas VOAE Gestión'),
(31137, 1, 114, '2021-08-06 22:05:09', 'INGRESO', 'A Actividades Externas'),
(31138, 1, 114, '2021-08-06 22:05:21', 'INGRESO', 'A Horas VOAE Gestión'),
(31139, 1, 114, '2021-08-06 22:06:08', 'INGRESO', 'A Actividades Externas'),
(31140, 1, 114, '2021-08-06 22:06:35', 'INGRESO', 'A Actividades Externas'),
(31141, 1, 114, '2021-08-06 22:07:11', 'INGRESO', 'A Actividades Externas'),
(31142, 1, 114, '2021-08-06 22:08:09', 'INGRESO', 'A Actividades Externas'),
(31143, 1, 114, '2021-08-06 22:09:02', 'INGRESO', 'A Horas VOAE Gestión'),
(31144, 1, 114, '2021-08-06 22:13:35', 'INGRESO', 'A Actividades Externas'),
(31145, 1, 114, '2021-08-06 22:18:07', 'INGRESO', 'A Horas VOAE Gestión'),
(31146, 1, 114, '2021-08-06 22:18:10', 'INGRESO', 'A Actividades Externas'),
(31147, 1, 114, '2021-08-06 22:19:53', 'INGRESO', 'A Actividades Externas'),
(31148, 1, 114, '2021-08-06 22:21:14', 'INGRESO', 'A Actividades Externas'),
(31149, 1, 114, '2021-08-06 22:21:26', 'INGRESO', 'A Actividades Externas'),
(31150, 1, 114, '2021-08-06 22:22:58', 'INGRESO', 'A Horas VOAE Gestión'),
(31151, 1, 114, '2021-08-06 22:23:00', 'INGRESO', 'A Actividades Externas'),
(31152, 1, 114, '2021-08-06 22:23:15', 'INGRESO', 'A Actividades Externas'),
(31153, 1, 114, '2021-08-06 22:24:28', 'INGRESO', 'A Actividades Externas'),
(31154, 1, 114, '2021-08-06 22:24:42', 'INGRESO', 'A Actividades Externas'),
(31155, 1, 114, '2021-08-06 22:24:57', 'INGRESO', 'A Actividades Externas'),
(31156, 1, 114, '2021-08-06 22:25:38', 'INGRESO', 'A Actividades Externas'),
(31157, 1, 114, '2021-08-06 22:26:04', 'INGRESO', 'A Horas VOAE Gestión'),
(31158, 1, 114, '2021-08-06 22:26:24', 'INGRESO', 'A Horas VOAE Gestión'),
(31159, 1, 114, '2021-08-06 22:26:26', 'INGRESO', 'A Actividades Externas'),
(31160, 1, 114, '2021-08-06 22:26:31', 'INGRESO', 'A Actividades Externas'),
(31161, 1, 114, '2021-08-06 22:32:52', 'INGRESO', 'A Actividades Externas'),
(31162, 1, 114, '2021-08-06 22:33:04', 'INGRESO', 'A Actividades Externas'),
(31163, 1, 114, '2021-08-06 22:35:20', 'INGRESO', 'A Actividades Externas'),
(31164, 1, 114, '2021-08-06 22:36:31', 'INGRESO', 'A Actividades Externas'),
(31165, 1, 114, '2021-08-06 22:36:46', 'INGRESO', 'A Actividades Externas'),
(31166, 1, 114, '2021-08-06 22:36:53', 'INGRESO', 'A Horas VOAE Gestión'),
(31167, 1, 114, '2021-08-06 22:36:54', 'INGRESO', 'A Actividades Externas'),
(31168, 1, 114, '2021-08-06 22:37:18', 'INGRESO', 'A Actividades Externas'),
(31169, 1, 114, '2021-08-06 22:37:21', 'INGRESO', 'A Horas VOAE Gestión'),
(31170, 1, 114, '2021-08-06 22:39:09', 'INGRESO', 'A Horas VOAE Gestión'),
(31171, 1, 114, '2021-08-06 22:39:11', 'INGRESO', 'A Actividades Externas'),
(31172, 1, 114, '2021-08-06 22:40:24', 'INGRESO', 'A Actividades Externas'),
(31173, 1, 114, '2021-08-06 22:41:03', 'INGRESO', 'A Actividades Externas'),
(31174, 1, 114, '2021-08-06 22:41:12', 'INGRESO', 'A Actividades Externas'),
(31175, 1, 114, '2021-08-06 22:41:54', 'INGRESO', 'A Actividades Externas'),
(31176, 1, 114, '2021-08-06 22:42:03', 'INGRESO', 'A Actividades Externas'),
(31177, 1, 114, '2021-08-06 22:42:36', 'INGRESO', 'A Actividades Externas'),
(31178, 1, 114, '2021-08-06 22:42:44', 'INGRESO', 'A Actividades Externas'),
(31179, 1, 114, '2021-08-06 22:43:00', 'INGRESO', 'A Horas VOAE Gestión'),
(31180, 1, 114, '2021-08-06 22:43:05', 'INGRESO', 'A Actividades Externas'),
(31181, 1, 114, '2021-08-06 22:44:43', 'INGRESO', 'A Actividades Externas'),
(31182, 1, 114, '2021-08-06 22:45:12', 'INGRESO', 'A Actividades Externas'),
(31183, 1, 114, '2021-08-06 22:48:11', 'INGRESO', 'A Actividades Externas'),
(31184, 1, 114, '2021-08-06 22:49:33', 'INGRESO', 'A Actividades Externas'),
(31185, 1, 114, '2021-08-06 22:50:15', 'INGRESO', 'A Actividades Externas'),
(31186, 1, 114, '2021-08-06 22:53:09', 'INGRESO', 'A Actividades Externas'),
(31187, 1, 114, '2021-08-06 22:54:13', 'INGRESO', 'A Actividades Externas'),
(31188, 1, 114, '2021-08-06 22:56:39', 'INGRESO', 'A Actividades Externas'),
(31189, 1, 114, '2021-08-06 22:56:54', 'INGRESO', 'A Horas VOAE Gestión'),
(31190, 1, 114, '2021-08-06 22:57:03', 'INSERTO', 'HORAS VOAE AL ALUMNO: Edward Alberto Alvarenga Rodriguez, LA CANTIDAD DE: 5 HORAS, DE LA ACTIVIDAD: Torneo Futbolito'),
(31191, 1, 114, '2021-08-06 22:57:28', 'INSERTO', 'HORAS VOAE AL ALUMNO: Samanta Ramirez, LA CANTIDAD DE: 30 HORAS, DE LA ACTIVIDAD: Torneo Futbolito'),
(31192, 1, 116, '2021-08-06 22:57:41', 'INGRESO', 'A Historial de Horas Alumno'),
(31193, 1, 114, '2021-08-06 22:57:45', 'INGRESO', 'A Horas VOAE Gestión'),
(31194, 1, 114, '2021-08-06 22:58:04', 'INSERTO', 'HORAS VOAE AL ALUMNO: Helmer Calix, LA CANTIDAD DE: 15 HORAS, DE LA ACTIVIDAD: Torneo Futbolito'),
(31195, 1, 114, '2021-08-06 22:58:20', 'INGRESO', 'A Actividades Externas'),
(31196, 1, 114, '2021-08-06 22:59:49', 'INGRESO', 'A Actividades Externas'),
(31197, 1, 114, '2021-08-06 23:00:06', 'INGRESO', 'A Actividades Externas'),
(31198, 1, 114, '2021-08-06 23:00:23', 'INGRESO', 'A Actividades Externas'),
(31199, 1, 114, '2021-08-06 23:11:08', 'INGRESO', 'A Actividades Externas'),
(31200, 1, 114, '2021-08-06 23:11:16', 'INGRESO', 'A Actividades Externas'),
(31201, 1, 114, '2021-08-06 23:12:04', 'INGRESO', 'A Actividades Externas'),
(31202, 1, 114, '2021-08-06 23:14:50', 'INGRESO', 'A Actividades Externas'),
(31203, 1, 114, '2021-08-06 23:15:13', 'INGRESO', 'A Actividades Externas'),
(31204, 1, 114, '2021-08-06 23:17:46', 'INGRESO', 'A Actividades Externas'),
(31205, 1, 114, '2021-08-06 23:18:04', 'INGRESO', 'A Actividades Externas'),
(31206, 1, 114, '2021-08-06 23:18:53', 'INGRESO', 'A Horas VOAE Gestión'),
(31207, 1, 114, '2021-08-06 23:19:05', 'INGRESO', 'A Actividades Externas');
...
(65, '22', '2021-08-06 19:01:21', 'CULTURA', 'UNAH', '2021-08-03', '2021-08-05', 'PRUEBA', '500', '3000', 'JUAN, PEDRO', 'NINGUNA', 6, 1, 23, 'SEGUNDO PERIODO', 'ACTIVIDAD INTERNA', 1),
...
(67, NULL, '2021-08-06 22:21:10', 'Torneo Futbolito', 'UNAH', '2021-08-01', '2021-08-05', 'probando actividad', '', '0', 'Facultad De Contaduria Publica', 'Actividad Externa', 3, 1, 5, 'Segundo Periodo', 'Actividad Externa', 0),
(70, NULL, '2021-08-06 23:18:04', 'CIENCIA', 'UNAH', '2021-08-01', '2021-08-05', 'prueba', '', '0', 'CONTADURIA PUBLICA', NULL, 3, 1, 23, 'Segundo Periodo', 'Actividad Externa', 0);
...
(312, 66, '2', 'JORDY FERNANDO PADILLA LICONA', '15', 'INFORMATICA ADMINISTRATIVA'),
(313, 66, '20131014386', 'BRAYAN ALEJANDRO CENTENO ROSALES', '8', 'ADMINISTRACION ADUANERA'),
(314, 66, '20131016521', 'ZULMA ARACELY VALLECIO UMANZOR', '7', 'CONTADURIA PUBLICA Y FINANZAS'),
(315, 66, '20141003016', 'ANDREA PAOLA PORTILLO COELLO', '8', 'ADMINISTRACION ADUANERA'),
(316, 66, '20141010388', 'DELSY ZUGELY GONZALES ESPINAL', '8', 'COMERCIO INTERNACIONAL'),
(317, 66, '20151000158', 'CARLOS EDUARDO ALVAREZ', '8', 'ADMINISTRACION ADUANERA'),
(318, 66, '20151000349', 'JORGE ALFONSO BACA FLORES', '8', 'INFORMATICA ADMINISTRATIVA'),
(319, 66, '20151003274', 'LUIS ALEXANDER MORAN TORRES', '8', 'INFORMATICA ADMINISTRATIVA'),
(320, 66, '20151003957', 'IVIS JANCARLO PINEDA BANEGAS', '8', 'INFORMATICA ADMINISTRATIVA'),
(321, 66, '20151004130', 'ARLYS LARISSA MEZA ALMENDAREZ', '8', 'ADMINISTRACION ADUANERA'),
(322, 66, '20151004328', 'MIRIAN YANETH REYES GODOY', '8', 'INFORMATICA ADMINISTRATIVA'),
(323, 66, '20151004576', 'EDER JOEL HERNANDEZ CALDERON', '8', 'ECONOMIA'),
(324, 66, '20151005546', 'LEONARDO ARTURO CENTENO PAVON', '8', 'INFORMATICA ADMINISTRATIVA'),
(325, 66, '20151021130', 'LUIS EDUARDO GARCIA MENDEZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(326, 66, '20151021564', 'ANTHONY JAVIER LOPEZ GARAY', '8', 'ADMINISTRACION ADUANERA'),
(327, 66, '20151031250', 'ELBA FABIOLA SUAZO AGUILERA', '7', 'ADMINISTRACION ADUANERA'),
(328, 66, '20152030631', 'AMILCAR AYARI NUÑEZ RODRIGUEZ', '8', 'ADMINISTRACION ADUANERA'),
(329, 66, '20161000113', 'CARMEN ELIZABETH BACA GONZALEZ', '7', 'ADMINISTRACION ADUANERA'),
(330, 66, '20161002475', 'DANIA LISETH LEMUS LEMUS', '8', 'ECONOMIA'),
(331, 66, '20161002731', 'ERIK FERNANDO GUTIERREZ MANZANARES', '7', 'ADMINISTRACION ADUANERA'),
(332, 66, '20161003679', 'LINDA CECILIA VILLATORO HERNANDEZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(333, 66, '20161003774', 'DEYSI RAQUEL ZEPEDA CRUZ', '8', 'COMERCIO INTERNACIONAL'),
(334, 66, '20161004548', 'ANDRES EDUARDO OCHOA ARANDA', '8', 'ADMINISTRACION ADUANERA'),
(335, 66, '20161005026', 'DIANA CAROLINA AMADOR CORRALES', '7', 'COMERCIO INTERNACIONAL'),
(336, 66, '20161005222', 'BELKIS NOHELIA DIAZ FUENTES', '7', 'ECONOMIA'),
(337, 66, '20161005285', 'JENNIFER AZUCENA CLAROS FLORES', '8', 'INFORMATICA ADMINISTRATIVA'),
(338, 66, '20161030222', 'JEFFRY JOSEPH AGUILAR CORRALES', '8', 'INFORMATICA ADMINISTRATIVA'),
(339, 66, '20161030540', 'JENNY NOHEMY CRUZ AVILA', '8', 'INFORMATICA ADMINISTRATIVA'),
(340, 66, '20161030758', 'ALEXA FERNANDA FLORES AGUILAR', '8', 'ADMINISTRACION ADUANERA'),
(341, 66, '20161030913', 'DANIEL ARTURO LOBO CERNA', '8', 'ECONOMIA'),
(342, 66, '20161031104', 'DANIELA BRIYITH MENDOZA GOMEZ', '8', 'COMERCIO INTERNACIONAL'),
(343, 66, '20161031471', 'JORDY FERNANDO PADILLA LICONA', '8', 'INFORMATICA ADMINISTRATIVA'),
(344, 66, '20161031659', 'NOELIA VANESA RAMOS RODRIGUEZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(345, 66, '20161031741', 'LUIS FERNANDO SANCHEZ VALLADARES', '8', 'INFORMATICA ADMINISTRATIVA'),
(346, 66, '20161031941', 'LUIS FERNANDO VILLALTA ALFARO', '8', 'INFORMATICA ADMINISTRATIVA'),
(347, 66, '20161032555', 'BRAYAN ISAIAS AMAYA AMADOR', '7', 'ADMINISTRACION ADUANERA'),
(348, 66, '20171000119', 'ALLAN LEONEL BONILLA GALEANO', '7', 'ADMINISTRACION ADUANERA'),
(349, 66, '20171000490', 'DARIELA SOFIA CACERES HERNANDEZ', '8', 'ECONOMIA'),
(350, 66, '20171000658', 'ERICK DAVID CASTILLO MENDOZA', '8', 'ADMINISTRACION ADUANERA'),
(351, 66, '20171000783', 'DANIELA MICHELLE MEZA CARDONA', '7', 'ECONOMIA'),
(352, 66, '20171000803', 'LUIS FERNANDO MEJIA CRUZ', '7', 'INFORMATICA ADMINISTRATIVA'),
(353, 66, '20171000851', 'JEIMY NICOLLE BORGES LARIOS', '8', 'ADMINISTRACION ADUANERA'),
(354, 66, '20171001102', 'CARLOS OMAR GUEVARA AVELAR', '8', 'ADMINISTRACION ADUANERA'),
(355, 66, '20171001597', 'ALEJANDRO JOSE LAGOS CALIX', '8', 'ECONOMIA'),
(356, 66, '20171001652', 'ANDREA POLET LOPEZ REYES', '8', 'ADMINISTRACION ADUANERA'),
(357, 66, '20171001853', 'DIANA CAROLINA HENRIQUEZ LOPEZ', '8', 'COMERCIO INTERNACIONAL'),
(358, 66, '20171002045', 'MARIO DAVID MORAZAN LOPEZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(359, 66, '20171002196', 'ISIS MABEL MARTINEZ AMADOR', '8', 'INFORMATICA ADMINISTRATIVA'),
(360, 66, '20171002335', 'MAILYN LUCIA MARTINEZ PINEDA', '8', 'INFORMATICA ADMINISTRATIVA'),
(361, 66, '20171003205', 'DAYSI SARAI ORTEGA PONCE', '7', 'ADMINISTRACION ADUANERA'),
(362, 66, '20171003514', 'JOHANN RANSES FLORES ROMERO', '7', 'INFORMATICA ADMINISTRATIVA'),
(363, 66, '20171003565', 'MAURA ISABEL RODRIGUEZ OLIVA', '7', 'INFORMATICA ADMINISTRATIVA'),
(364, 66, '20171004284', 'HAROL DIDIER AMADOR VALLE', '7', 'ADMINISTRACION ADUANERA'),
(365, 66, '20171004396', 'CINTYA DANIELA COLINDRES CARRANZA', '8', 'ADMINISTRACION ADUANERA'),
(366, 66, '20171004457', 'ALEJANDRA SARAHI ZELAYA SALGADO', '8', 'ECONOMIA'),
(367, 66, '20171005087', 'JESSI MAYLIN ESTRADA MALDONADO', '8', 'INFORMATICA ADMINISTRATIVA'),
(368, 66, '20171005100', 'CINDY MARIELA PORTILLO SALGADO', '7', 'ECONOMIA'),
(369, 66, '20171005216', 'JAFET AXIEL ESPINO CARRASCO', '8', 'INFORMATICA ADMINISTRATIVA'),
(370, 66, '20171005336', 'ABEL JOSUE PEREZ LOPEZ', '8', 'ECONOMIA'),
(371, 66, '20171005416', 'MIGUEL FERNANDO ARAMBU SANCHEZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(372, 66, '20171005462', 'ALISSON ALEJANDRA ROQUE SALINAS', '8', 'ADMINISTRACION ADUANERA'),
(373, 66, '20171005901', 'EDGAR VIRGILIO MARTINEZ CASTILLO', '8', 'ADMINISTRACION ADUANERA'),
(374, 66, '20171006373', 'DEMILSON SAMUEL QUIROZ LOPEZ', '8', 'ADMINISTRACION ADUANERA'),
(375, 66, '20171030181', 'MARIO ANTONIO HERNANDEZ ROMERO', '8', 'INFORMATICA ADMINISTRATIVA'),
(376, 66, '20171030193', 'DENIS ALEXANDER ALVARADO FERRERA', '8', 'ECONOMIA'),
(377, 66, '20171030393', 'ELVIN EDUARDO BORJAS GIRON', '8', 'ECONOMIA'),
(378, 66, '20171030517', 'JONATHAN MAYCOL CARRASCO MATAMOROS', '8', 'INFORMATICA ADMINISTRATIVA'),
(379, 66, '20171030769', 'CLAUDIA GABRIELA CHACON PONCE', '8', 'COMERCIO INTERNACIONAL'),
(380, 66, '20171031019', 'DAYANA NICOL ESCOBAR LAGOS', '8', 'ADMINISTRACION ADUANERA'),
(381, 66, '20171031159', 'MARIA FERNANDA GUTIERREZ BELIZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(382, 66, '20171031255', 'JOEL POMPILIO GALLO PEÑA', '7', 'INFORMATICA ADMINISTRATIVA'),
(383, 66, '20171031295', 'DANIA GISEEL ESPINOZA ANDRADE', '8', 'ADMINISTRACION ADUANERA'),
(384, 66, '20171031352', 'FERNANDO JOSE GALO GUEVARA', '8', 'ECONOMIA'),
(385, 66, '20171032339', 'JEANINE ESTEFANIA PERDOMO PERNUDI', '8', 'INFORMATICA ADMINISTRATIVA'),
(386, 66, '20171033029', 'JADE ALEXA AYALA LOPEZ', '7', 'ADMINISTRACION ADUANERA'),
(387, 66, '20171033102', 'JOSE VICTOR SIERRA LAGOS', '8', 'INFORMATICA ADMINISTRATIVA'),
(388, 66, '20171033477', 'DANIA MERARY VARGAS GALO', '8', 'ADMINISTRACION ADUANERA'),
(389, 66, '20171033499', 'MIGUEL ANTONIO TORRES TREJO', '8', 'INFORMATICA ADMINISTRATIVA'),
(390, 66, '20171034113', 'JERSON URIEL CABALLERO CARRANZA', '8', 'ADMINISTRACION ADUANERA'),
(391, 66, '20171034560', 'JONATHAN FERNANDO DIAZ PARADA', '8', 'INFORMATICA ADMINISTRATIVA'),
(392, 66, '20171034822', 'CATHERIN ALEJANDRA MENDOZA ROSALES', '8', 'ADMINISTRACION ADUANERA'),
(393, 66, '20171035152', 'JARED JOSAFAT ORELLANA TOLEDO', '8', 'ADMINISTRACION ADUANERA'),
(394, 66, '20172030632', 'GERALDINA MICHELLE LAGOS FLORES', '8', 'ADMINISTRACION ADUANERA'),
(395, 66, '20172500072', 'CRISTIAN JOSUE HERNANDEZ MORGA', '8', 'ECONOMIA'),
(396, 66, '20172500214', 'DINORA YAMILETH VAQUEDANO SORIANO', '8', 'COMERCIO INTERNACIONAL'),
(397, 66, '20181000003', 'DANIELA MICHELL ALONZO GOMEZ', '8', 'COMERCIO INTERNACIONAL'),
(398, 66, '20181000028', 'ALLAN MAURICIO ARDON MONTALVAN', '8', 'ECONOMIA'),
(399, 66, '20181000479', 'MENDEL BREZHNEV AGUILAR ROMERO', '8', 'INFORMATICA ADMINISTRATIVA'),
(400, 66, '20181000755', 'LESLY PATRICIA CRUZ MARADIAGA', '8', 'INFORMATICA ADMINISTRATIVA'),
(401, 66, '20181000828', 'LUIS CARLOS DELCID BONILLA', '8', 'INFORMATICA ADMINISTRATIVA'),
(402, 66, '20181001457', 'ABBY JUDITH FLORES DELCID', '8', 'ADMINISTRACION ADUANERA'),
(403, 66, '20181001501', 'NANCY GICELA DOMINGUEZ CRUZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(404, 66, '20181001502', 'GUSTAVO ARMANDO FIGUEROA MOTIÑO', '8', 'ECONOMIA'),
(405, 66, '20181001947', 'MARIA JHOSE GARCIA MUNGUIA', '8', 'INFORMATICA ADMINISTRATIVA'),
(406, 66, '20181002794', 'ANA LUCIA MARTINEZ PEÑA', '8', 'ADMINISTRACION ADUANERA'),
(407, 66, '20181003053', 'JEYMY NOHEMY ZELAYA AMADOR', '8', 'INFORMATICA ADMINISTRATIVA'),
(408, 66, '20181003095', 'JORGE FRANCISCO BONILLA GALEANO', '8', 'INFORMATICA ADMINISTRATIVA'),
(409, 66, '20181003138', 'BEYRA NICOL MOLINA CASTRO', '7', 'ECONOMIA'),
(410, 66, '20181003172', 'LUZ MARIA MONTOYA MEDINA', '7', 'INFORMATICA ADMINISTRATIVA'),
(411, 66, '20181003320', 'DIEGO FERNANDO ANTUNEZ BUSTILLO', '8', 'COMERCIO INTERNACIONAL'),
(412, 66, '20181003485', 'DANELIA ESTHER MARTINEZ HENRIQUEZ', '7', 'ADMINISTRACION ADUANERA'),
(413, 66, '20181003751', 'ESCARLET MILAGRO ORTEGA LANZA', '8', 'ADMINISTRACION ADUANERA'),
(414, 66, '20181003799', 'LEONELA YASMIN PINEDA BARAHONA', '8', 'INFORMATICA ADMINISTRATIVA'),
(415, 66, '20181004409', 'DANIEL EDUARDO MARTINEZ SARAVIA', '8', 'COMERCIO INTERNACIONAL'),
(416, 66, '20181004447', 'HASLER FABIAN ROMERO ALVARADO', '7', 'ADMINISTRACION ADUANERA'),
(417, 66, '20181004602', 'ANDREA NICOLLE PAZ TORRES', '7', 'ADMINISTRACION ADUANERA'),
(418, 66, '20181004727', 'DARIELA LIZETH VILLANUEVA MOLINA', '8', 'ECONOMIA'),
(419, 66, '20181005028', 'MISAEL ESAU LAGOS BARRIENTOS', '7', 'INFORMATICA ADMINISTRATIVA'),
(420, 66, '20181005152', 'NELZON ANTONIO RODAS MEJIA', '8', 'INFORMATICA ADMINISTRATIVA'),
(421, 66, '20181005268', 'DELMY GUADALUPE SUAZO GARCIA', '8', 'ADMINISTRACION ADUANERA'),
(422, 66, '20181005354', 'MIRIAN REGINA RODRIGUEZ NUÑEZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(423, 66, '20181005483', 'DANIELA ISABEL ALCANTARA ZELAYA', '7', 'COMERCIO INTERNACIONAL'),
(424, 66, '20181005571', 'ANDREA YOSSANA RODAS CASTILLO', '8', 'ECONOMIA'),
(425, 66, '20181005628', 'GABRIELA MARISOL COLINDRES RIOS', '7', 'ECONOMIA'),
(426, 66, '20181005648', 'GABRIELA ALEJANDRA RAUDALES CARDENAS', '8', 'ECONOMIA'),
(427, 66, '20181005949', 'ELMER SAIT RODRIGUEZ REYES', '7', 'ECONOMIA'),
(428, 66, '20181006102', 'ALEXANDRA LISBETH GARCIA ANDINO', '8', 'ADMINISTRACION ADUANERA'),
(429, 66, '20181006449', 'HEIMY CRISTAL RODRIGUEZ CASTELLON', '8', 'ADMINISTRACION ADUANERA'),
(430, 66, '20181006730', 'ESTHER SARAHI BARRIENTOS MARTINEZ', '8', 'ADMINISTRACION ADUANERA'),
(431, 66, '20181006840', 'LUIS STEVEN VASQUEZ PEREZ', '7', 'INFORMATICA ADMINISTRATIVA'),
(432, 66, '20181007078', 'DIEGO GABRIEL VALLADARES SANCHEZ', '8', 'COMERCIO INTERNACIONAL'),
(433, 66, '20181007175', 'FARID DANIEL VILCHEZ GONZALES', '8', 'ADMINISTRACION ADUANERA'),
(434, 66, '20181007185', 'EDUARDO JOSUE VILLARS CASTILLO', '7', 'ADMINISTRACION ADUANERA'),
(435, 66, '20181007231', 'ANGEL DANIEL VASQUEZ ALMENDARES', '8', 'ECONOMIA'),
(436, 66, '20181007648', 'JASON OMAR RODRIGUEZ QUIÑONEZ', '8', 'INFORMATICA ADMINISTRATIVA'),
(437, 66, '20181007693', 'ZULMA YONARI FLORES AVILA', '8', 'CONTADURIA PUBLICA Y FINANZAS'),
(438, 66, '20181030559', 'MARYORIE GICELLE MENDOZA GARCIA', '8', 'INFORMATICA ADMINISTRATIVA'),
(439, 66, '20181031079', 'NANCY KARINA CHAVARRIA TACHE', '8', 'INFORMATICA ADMINISTRATIVA'),
(440, 66, '20181031181', 'JESSICA CAROLINA CARRANZA OSORTO', '8', 'INFORMATICA ADMINISTRATIVA'),
(441, 66, '20181031307', 'CLAUDIA MARIELA GALEAS REYES', '8', 'COMERCIO INTERNACIONAL'),
(442, 66, '20181031519', 'FRANKLIN ADALID DOMINGUEZ COELLO', '8', 'ADMINISTRACION ADUANERA'),
(443, 66, '20181032196', 'ANDREA SOFIA PONCE CASTRO', '7', 'ECONOMIA'),
(444, 66, '20181033131', 'LUISA LIZETH ARIAS COTO', '8', 'INFORMATICA ADMINISTRATIVA'),
(445, 66, '20191000015', 'JESSY MARIA ALVARADO ESPINAL', '8', 'INFORMATICA ADMINISTRATIVA'),
(446, 66, '20191000152', 'DULCE MARIA FRANCO VALLADARES', '8', 'COMERCIO INTERNACIONAL'),
(447, 67, '20211002890', 'Linda Ceciclia Villatoro Hernandez', '30', 'Informatica Administrativa'),
(448, 67, '20151002890', 'Edward Alberto Alvarenga Rodriguez', '5', 'Informatica Administrativa'),
(449, 67, '20141010101', 'Samanta Ramirez', '30', 'Informatica Administrativa'),
(450, 67, '20131015093', 'Helmer Calix', '15', 'Informatica Administrativa');
...
(82, 2, '2021-08-02', 74, 'PRUEBA', 1, '2021-08-06'),
(83, 2, '2021-08-04', 66, 'JHJKKGHJGH', 1, '2021-08-06'),
(84, 2, '2021-08-02', 74, 'HGJHGHG', 1, '2021-08-06'),
...
(7, 66, 'gfdgdgdggg', 'prueba', 'prueba', '!&quot;%/()?¡', '2021-08-06', 34, 1, 1);
...
(25, 'NM-0001', NULL, 0, 'EVER', 'EVERDYHFFGFG', '2021-08-06', 'FDFDSFSDFGDFGDFG', 'JHGJGHJGHJGHJGH'),
...
--
ALTER TABLE `tbl_bitacora`
  MODIFY `Id_bitacora` bigint(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31208;
...
--
ALTER TABLE `tbl_voae_actividades`
  MODIFY `id_actividad_voae` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Campo llave - índice de la tabla', AUTO_INCREMENT=71;
...
--
ALTER TABLE `tbl_voae_asistencias`
  MODIFY `id_asistencia` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=451;
...
--
ALTER TABLE `tbl_voae_faltas_conductas`
  MODIFY `id_falta` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT de la tabla `tbl_voae_informes`
--
ALTER TABLE `tbl_voae_informes`
  MODIFY `id_informe` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'indice de la tabla - identificador', AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_voae_repositorios`
  MODIFY `id_repositorio` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Identificador o indice de la tabla', AUTO_INCREMENT=35;
