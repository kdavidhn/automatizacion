...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-08-2021 a las 04:24:08
...
INSERT INTO tbl_voae_actividades (nombre_actividad,ubicacion,fch_inicial_actividad,fch_final_actividad,descripcion,staff_alumnos,id_estado,id_usuario_registro,id_ambito,periodo,tipo_actividad)
   VALUES (upper(nombre_act),upper(ubicacion),fecha_inicio,fecha_final,upper(descripcion),upper(ente),'3',usuario,ambito,periodo,'ACTIVIDAD EXTERNA');
END IF;
END$$
...
(65, '22', '2021-08-15 19:06:00', 'CULTURA', 'UNAH', '2021-08-03', '2021-08-05', 'PRUEBA', '500', '3000', 'JUAN, PEDRO', 'NINGUNA', 6, 1, 23, 'SEGUNDO PERIODO', 'ACTIVIDAD INTERNA', 1),
...
(104, NULL, '2021-08-15 18:58:27', 'DEPORTES', 'POLIDEPORTIVO', '2021-08-01', '2021-08-06', 'PROBANDO ACTIVIDAD', '', '0', 'INGENIERIA INDUSTRIAL', NULL, 7, 1, 5, 'PRIMER PERIODO', 'ACTIVIDAD EXTERNA', 0),
(105, '2', '2021-08-15 18:46:16', 'DFDSFSD', 'UNAH', '2021-08-14', '2021-08-24', 'PROBANDO ACTIVIDAD', '500', '3000', 'INGENIERIA ELECTRICA', 'por falta de tiempo', 4, 1, 23, 'PRIMER PERIODO', 'ACTIVIDAD INTERNA', 0),
(106, '13', '2021-08-11 21:29:47', 'CULTURA', 'UNAH', '2021-08-13', '2021-08-25', 'PROBANDO ACTIVIDAD', '500', '3000', 'AMBIENTAL', 'NINGUNA', 4, 1, 23, 'SEGUNDO PERIODO', 'ACTIVIDAD INTERNA', 0),
...
(108, '15', '2021-08-16 20:11:12', 'ACTIVIDAD DE BAILE', 'UNAH', '2021-08-18', '2021-08-31', 'GFGFGDFG', '500', '3000', 'JUAN, PEDRO', 'NINGUNA', 1, 1, 23, 'Primer Periodo', 'ACTIVIDAD INTERNA', 0),
(109, '13', '2021-08-16 20:10:24', 'PRUEBA', 'CIIE', '2021-08-18', '2021-08-26', '0', '500', '3000', 'JUAN, PEDRO', 'NINGUNA', 2, 1, 23, '0', 'ACTIVIDAD INTERNA', 0),
(110, '15', '2021-08-16 20:23:05', 'ACTIVIDAD DE BAILE', 'UNAH', '2021-08-18', '2021-08-31', '0', '500', '3000', 'JUAN, PEDRO', 'NINGUNA', 7, 1, 23, '0', 'ACTIVIDAD INTERNA', 0),
(111, '32', '2021-08-16 20:20:39', 'CULTURA', 'CIIE', '2021-08-19', '2021-08-30', '0', '500', '500', 'JUAN, PEDRO', 'NINGUNA', 2, 1, 23, '0', 'ACTIVIDAD INTERNA', 0);
...
(588, 104, '20101002890', 'Enrique  Rivera', '15', 'Informatica Administrativa');
...
--
ALTER TABLE `tbl_bitacora`
  MODIFY `Id_bitacora` bigint(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31734;
...
--
ALTER TABLE `tbl_voae_actividades`
  MODIFY `id_actividad_voae` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Campo llave - índice de la tabla', AUTO_INCREMENT=112;
...
--
ALTER TABLE `tbl_voae_asistencias`
  MODIFY `id_asistencia` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=589;
